    ...
    <div class="card-body p-4">
        ...
        <div class="mt-2">
            ...
            <p class="text-muted small mt-2 mb-0">
                <?php
                if ($progressoCiclo['concluidas'] == 0) {
                    echo 'Ainda não começaste o ciclo. Envia a primeira etapa!';
                } elseif ($progressoCiclo['concluidas'] < 5) {
                    echo 'Estás no bom caminho! Continua a submeter as tuas reflexões.';
                } else {
                    echo 'Trabalho incrível! Concluíste todas as etapas do ciclo.';
                }
                ?>
            </p>
        </div>
...
<div class="row g-3">
    <div class="col-lg-6">
        <div class="card border-0 rounded-4 h-100">
            <div class="card-body p-4">
                <h2 class="h5 fw-semibold text-dark mb-3">🏆 Ranking Semanal</h2>
                <?php if (!empty($ranking)): ?>
                    ...
                    <div class="d-flex align-items-center justify-content-between py-3 border-bottom">
                        ...
                        <span class="badge bg-light text-dark">Top Aluno</span>
                    </div>
                    <?php endforeach; ?>
                <?php else: ?>
