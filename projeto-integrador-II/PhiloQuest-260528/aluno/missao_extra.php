...
<?php else: ?>
    <div class="d-flex flex-column gap-4">
        <?php foreach ($missoes as $missao):
            ...
            $xpBadge = (int) ($missao['xp_recompensa'] ?? 80);
            $respostaAtual = (string) ($missao['resposta_texto'] ?? '');
        ?>
        <article class="card border-0 rounded-4 overflow-hidden shadow-none">
            <div class="card-header missao-aluno-banner border-0 text-white p-4">
                <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <p class="small mb-1 opacity-90">
                                Missão enviada por Prof. <?= htmlspecialchars($missao['professor_nome']) ?>
                            </p>
                            <div class="d-flex flex-wrap gap-2">
                                <span class="badge bg-white text-primary">+<?= $xpBadge ?> XP</span>
                ...
                <div class="missao-ref-box rounded-3 p-3 mb-4">
                    ...
                    <a href="<?= htmlspecialchars($missao['link_referencia']) ?>" target="_blank" rel="noopener"
                       class="text-primary text-decoration-none">
                        ...
                        <?= htmlspecialchars($missao['link_referencia']) ?>
                    </a>
                </div>
                <?php endif; ?>
