...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['vincular_turma'])) {
    ...
    if ($codigoTurma !== '') {
        try {
            $professorService->vincularTurma($professorId, $codigoTurma);
...
<div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
    <div>
        ...
        <p class="text-muted small mb-0">Crie, vincule e acompanhe o andamento das suas turmas.</p>
    </div>
</div>
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center gap-2 mb-3 p-2 bg-light rounded-3">
                            ...
                            <button type="button" class="btn btn-outline-primary btn-sm"
                                onclick="navigator.clipboard.writeText('<?= htmlspecialchars($turma['codigo_turma'], ENT_QUOTES) ?>'); alert('Código copiado!');">
