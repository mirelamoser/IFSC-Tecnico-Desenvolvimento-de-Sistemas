...
public class DatabaseMySQL implements Database {
    ...
    public Connection conectar() {
        try {
            ...
            //String url = "jdbc:mysql://localhost:3306/db_lavacao?useTimezone=true&serverTimezone=America/Sao_Paulo";
            //String url = "jdbc:mysql://localhost:3306/db_lavacao";//MySQL 5
